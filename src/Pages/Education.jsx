        ...
        <Container
            ...
            <center>
                <Row>
                    ...
                    <Col>
                        <img src={im} alt="asu seal" className="asu_seal" width="400" height="400"></img>  <p id="know_more" style={{ color: "maroon", fontWeight: "bolder" }} >I would like to know more about you! If you care to share click the button to send me an email.</p>
                    ...
                    <Col>
                        <ul className="ed_bullets" style={{ color: "black", fontWeight: "bold", fontSize: "10px" }}>
                            <li>
                        ...
                        <Link to={`/hobbies`}>< span className="tite"  ><Button id="nav_hobbies"> Check out my hobbies.</Button></span></Link>
                    </Col>
                </Row>
